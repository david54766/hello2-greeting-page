...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Prima Donna AI™ — Executive Coaching for Childcare Leaders" },
      ...
      { name: "twitter:title", content: "Prima Donna AI™ — Executive Coaching for Childcare Leaders" },
