...
// ---------- Objectionable content filtering (new posts/replies only) ----------
...
// Fails open: a moderation outage must never break Elite posting for the
...
// ---------- Elite conversations (unchanged action names + response shapes) ----------
